...
const testimonials = [
  {
    ...
    content:
      'Absolutely incredible work! The animations brought our brand to life in ways we never imagined.',
    rating: 5
  },
  {
    name: 'Michael Chen',
    ...
    avatar: '/placeholder.svg?height=40&width=40',
    content:
      'The attention to detail and smooth animations exceeded all our expectations. Highly recommended!',
    rating: 5
  },
  {
    ...
    avatar: '/placeholder.svg?height=40&width=40',
    content:
      'Professional, creative, and delivered exactly what we needed. The motion design is phenomenal.',
    rating: 5
  }
];
    ...
    >
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        >
          ...
          <motion.p
            ...
            variants={itemVariants}
          >
            Creating extraordinary digital experiences through the power of
        ...
        >
          <motion.div className="text-center mb-16" variants={itemVariants}>
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
              Combining creativity with technology to deliver exceptional
              results
            </p>
          </motion.div>
              ...
              {projects.map((project) => (
                <motion.div
                  ...
                  className={`p-4 rounded-lg cursor-pointer transition-all ${
                    selectedProject === projects.indexOf(project)
                ...
                >
                  <div className="flex items-center justify-between">
                    ...
                    <motion.div
                      animate={{
                        rotate:
                          selectedProject === projects.indexOf(project) ? 90 : 0
                      }}
      ...
      <section className="py-20 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-300">
              Drag the cards to explore testimonials
            </p>
          </motion.div>
        ...
        <motion.div className="max-w-4xl mx-auto text-center" layout>
          ...
          >
            ...
            <motion.p
              ...
              transition={{ delay: 0.2 }}
            >
              Let's bring your ideas to life with stunning animations and
              interactions
            </motion.p>
      ...
      <motion.footer className="py-12 px-4 border-t border-white/10" layout>
        <motion.p
          ...
          viewport={{}}
        >
          © 2024 MotionMagic. Crafted with passion and powered by Framer
          Motion.
        </motion.p>
      </motion.footer>
    </motion.div>
